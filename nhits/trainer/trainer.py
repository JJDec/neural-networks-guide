"""Training loop, early stopping, and checkpointing for N-HiTS.
...
class Trainer:
    ...
    cfg:
        ``NHiTSConfig`` containing all hyperparameters.
    device:
    ...
    def __init__(
        ...
        if cfg.wandb_enabled and _WANDB_AVAILABLE:
            self._wandb_run = _wandb.init(
                ...
                tags=["nhits", "forecasting", "electricity"],
    ...
    def fit(
        ...
        print(f"\n{'='*60}")
        print(f"  N-HiTS training — device: {self.device}")
        ...
        if self._wandb_run is not None:
            ...
            artifact = _wandb.Artifact(
                ...
                type="model",
                description="Best N-HiTS checkpoint saved during training",
            )
