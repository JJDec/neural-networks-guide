...
Provides:
  ...
  - ``build_dataloaders`` — returns train / val / test DataLoaders for N-HiTS
"""
...
def build_dataloaders(cfg: NHiTSConfig) -> tuple[DataLoader, DataLoader, DataLoader]:
